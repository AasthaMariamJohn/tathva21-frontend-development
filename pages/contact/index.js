			...
			<div className={style['body']}>
				<div className={style['info']}>
					...
					<div className={style['item']}>
						...
						<p className={style['data']}>National Institute of Technology, Calicut Mukkam Road, Kattangal Kerala - 673601</p>
					</div>
					<div className={style['item']}>
				...
				<div className={style['form']}>
					...
					<form method='POST' onSubmit={handlesubmit}>
						...
						<textarea name='' id='' cols='30' rows='10' className={style['input']} placeholder='message'></textarea>
