...
import { CollegeNameInput, DistrictInput, NameInput, PhoneInput, StateInput, TathvaIdInput, YearOfStudyInput } from '@/components/profile/inputs'
...
export default function Main() {
	const { userProfile, setUserProfile, inEditMode, setInEditMode, reRender, allInOne } = useProfileContext()
