...
export default function getRegisteredWorkshopInfo(eventId,jwt,setWorkshop,setUserWorkshopDetails) {
  axios
    .get(`${process.env.NEXT_PUBLIC_BACKEND_URL}/user-workshop-details/${eventId}`,
    {
          headers:{
