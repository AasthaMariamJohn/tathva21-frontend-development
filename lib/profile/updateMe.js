...
export default function updateMe(user, allInOne, router, setUser) {
  if (!allInOne.name || !allInOne.phoneNumber || !allInOne.collegeName) {
  ...
  axios
    ...
    .then(() => {
      setUser({ ...user, name: allInOne.name });
